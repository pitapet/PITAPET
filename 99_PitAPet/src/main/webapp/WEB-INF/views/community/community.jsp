  ...
  <body>
    <header id="header">
      ...
      <ul class="header__menu">
        ...
        <li><a href="${ path }/product/product">Product</a></li>
        <li><a href="${ path }/community/community">Community</a></li>
        <li><a href="${ path }/organization/organization">Organization</a></li>
