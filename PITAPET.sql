...
COMMENT ON COLUMN PRODUCT.COLOR IS '상품색상';
COMMENT ON COLUMN PRODUCT.STOCK IS '재고수량';
COMMENT ON COLUMN PRODUCT.IMG_NAME IS '이미지파일명';
COMMENT ON COLUMN PRODUCT.STATUS IS '상태값(Y/N)';
COMMENT ON COLUMN PRODUCT.CREATED_DATE IS '작성일';
COMMENT ON COLUMN PRODUCT.MODIFY_DATE IS '수정일';

INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, 'HAND GRIPPER', '핸드폰에 부착할 수 있는 그립톡입니다.', 10000, 'WHITE', 5, 'handgripper_white_01', 'Y', DEFAULT, DEFAULT);

INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, 'PANDENT', '가방, 핸드폰 등에 달고 다닐 수 있는 팬던트입니다.', 15000, 'GOLD', 0, 'pandent_gold_01', 'Y', DEFAULT, DEFAULT);
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, 'PANDENT', '가방, 핸드폰 등에 달고 다닐 수 있는 팬던트입니다.', 15000, 'ROSEGOLD', 0, 'pandent_rosegold_01', 'Y', DEFAULT, DEFAULT);
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, 'PANDENT', '가방, 핸드폰 등에 달고 다닐 수 있는 팬던트입니다.', 15000, 'SILVER', 0, 'pandent_silver_01', 'Y', DEFAULT, DEFAULT);

INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, 'FOOT MAT', '문 앞에 배치할 수 있는 발매트입니다.', 12000, 'MINT', 0, 'footmat_mint_01', 'Y', DEFAULT, DEFAULT);
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, 'FOOT MAT', '문 앞에 배치할 수 있는 발매트입니다.', 12000, 'BLUE', 0, 'footmat_blue_01', 'Y', DEFAULT, DEFAULT);
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, 'FOOT MAT', '문 앞에 배치할 수 있는 발매트입니다.', 12000, 'WHITE', 0, 'footmat_white_01', 'Y', DEFAULT, DEFAULT);
...
CREATE TABLE PRODUCT_IMAGE (
    ...
    CONSTRAINT FK_IMG_PRODUCT_NO FOREIGN KEY(PRODUCT_NO) REFERENCES PRODUCT(NO) ON DELETE SET NULL
);
...
COMMENT ON COLUMN PRODUCT_IMAGE.NO IS '상품이미지번호';
COMMENT ON COLUMN PRODUCT_IMAGE.PATH IS '상품이미지경로';
COMMENT ON COLUMN PRODUCT_IMAGE.PRODUCT_NO IS '상품번호';

INSERT INTO PRODUCT_IMAGE VALUES(SEQ_PRODUCT_IMG_NO.NEXTVAL, 'product/handgripper_white_01.png', 1);

-- 상품번호로 이미지 경로 조회
SELECT P.NO AS 상품번호, P.TITLE, P.COLOR, P.IMG_NAME, I.PATH
FROM PRODUCT_IMAGE I
JOIN PRODUCT P ON (I.PRODUCT_NO = P.NO);
