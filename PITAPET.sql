...
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, '그립톡', '핸드폰에 부착할 수 있는 그립톡입니다.', 10000, 'WHITE', 5, NULL, NULL, 'Y', DEFAULT, DEFAULT);
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, '팬던트', '가방, 핸드폰 등에 달고 다닐 수 있는 팬던트입니다.', 15000, 'GOLD', 0, NULL, NULL, 'Y', DEFAULT, DEFAULT);
INSERT INTO PRODUCT VALUES(SEQ_PRODUCT_NO.NEXTVAL, '발매트', '문 앞에 배치할 수 있는 발매트입니다.', 12000, 'MINT', 0, NULL, NULL, 'Y', DEFAULT, DEFAULT);
...
COMMENT ON COLUMN CART.NO IS '주문번호';
COMMENT ON COLUMN CART.PRICE IS '주문가격';
COMMENT ON COLUMN CART.COUNT IS '주문수량';
COMMENT ON COLUMN CART.MEMBER_NO IS '회원번호';
COMMENT ON COLUMN CART.PRODUCT_NO IS '상품번호';

INSERT INTO CART VALUES(SEQ_CART_NO.NEXTVAL, 20000, 2, 1, 1);
INSERT INTO CART VALUES(SEQ_CART_NO.NEXTVAL, 30000, 2, 1, 2);
